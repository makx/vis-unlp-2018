...
class App extends Component {
  constructor (props) {
    ...
    this.state = {
      ...
      purchasesByProduct: [],
      rawPurchasesByManufacturer: [],
      rawPurchasesByProduct: []
    }
  }
  ...
  componentWillMount () {
    ...
    d3.tsv('./pedidosCordenados.tsv', function (data) {
      ...
      this.setState({
        ...
        rawPurchasesByManufacturer: purchasesByManufacturer,
        rawPurchasesByProduct: purchasesByProduct
      })
    })
  }
  ...
  filterItemsByManufacturer (option) {
    ...
    let purchasesByManufacturer = this.getPurchasesByManufacturer(data)
    let purchasesByProduct = this.getPurchasesByProduct(data)
    this.setState({
      data: data,
  ...
  render() {
    ...
    return <div className="App">
      <div className="App-instructions">
        ...
        {this.state.data.length &&  <MapSpain data={this.state.data} />}
        <BarChart purchasesByManufacturer={purchasesByManufacturer} purchasesByProduct={purchasesByProduct}  />
        </div>}
      </div>
    </div>
  }
